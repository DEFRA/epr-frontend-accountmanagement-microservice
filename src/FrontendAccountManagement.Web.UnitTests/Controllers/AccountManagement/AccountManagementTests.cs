...
public class AccountManagementTests : AccountManagementTestBase
{
    ...
    [TestMethod]
    public async Task EmployeeOrBasicAdminHandler_Should_Fail_With_User_ServiceRole_Basic()
    {
        // data
        var mockUserData = new UserData
        {
        ...
        var requirements = new List<IAuthorizationRequirement>
                                    {
                                        new EmployeeOrBasicAdminRequirement( Core.Enums.ServiceRole.Basic,
                                            PersonRole.Employee,
                                            PersonRole.Admin
                                            ),
                                    };
    ...
    [TestMethod]
    public async Task EmployeeOrBasicAdminHandler_Should_Fail_With_User_ServiceRole_RegulatorAdmin()
    {
        // data
        var mockUserData = new UserData
        {
        ...
        var requirements = new List<IAuthorizationRequirement>
                                    {
                                        new EmployeeOrBasicAdminRequirement( Core.Enums.ServiceRole.RegulatorAdmin,
                                            PersonRole.Employee,
                                            PersonRole.Admin
                                            ),
                                    };
    ...
    [TestMethod]
    public async Task EmployeeOrBasicAdminHandler_Should_Succeed_With_User_ServiceRole_Approved()
    {
        // data
        var mockUserData = new UserData
        {
        ...
        var requirements = new List<IAuthorizationRequirement>
                                    {
                                        new EmployeeOrBasicAdminRequirement( Core.Enums.ServiceRole.Approved,
                                            PersonRole.Employee,
                                            PersonRole.Admin
                                            ),
                                    };
    ...
    [TestMethod]
    public async Task EmployeeOrBasicAdminHandler_Should_Succeed_With_User_ServiceRole_Delegated()
    {
        // data
        var mockUserData = new UserData
        {
        ...
        var requirements = new List<IAuthorizationRequirement>
                                    {
                                        new EmployeeOrBasicAdminRequirement( Core.Enums.ServiceRole.Delegated,
                                            PersonRole.Employee,
                                            PersonRole.Admin
                                            ),
                                    };
