...
[TestClass]
public class TeamMemberEmailTests : ReExAccountManagementTestBase
{
    ...
    public async Task GivenOnTeamMemberEmailPage_WhenTeamMemberEmailPageHttpPostCalled_ThenRedirectToPermissionsPage_AndUpdateSession()
    {
        ...
        // Assert
        result.ActionName.Should().Be(nameof(ReExAccountManagementController.TeamMemberPermissions));
