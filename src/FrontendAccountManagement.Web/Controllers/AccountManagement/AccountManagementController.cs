...
public class AccountManagementController : Controller
{
    ...
    //    if (serviceRole.ToLower() == ServiceRoles.BasicUser.ToLower() && (roleInOrganisation == RoleInOrganisation.Admin || roleInOrganisation == RoleInOrganisation.Employee))
    //    {
    //       var reponse = await _facadeService.UpdatePersonalDetailsAsync(userData.Id.Value, userOrg.Id.Value, _serviceSettings.ServiceKey, userDetailsDto);
    ...
    //    }
    //    else if ((serviceRole.ToLower() == ServiceRoles.ApprovedPerson.ToLower() 
    //        || serviceRole.ToLower() == ServiceRoles.DelegatedPerson.ToLower()) 
    //        && (roleInOrganisation == RoleInOrganisation.Admin || 
    //        roleInOrganisation == RoleInOrganisation.Employee))
    //    {  // Approved or Delegated users - User.IsDelegatedPerson || User.IsApprovedPerson
