...
{
    public static class LocalizerName
    {
        public const string UpdateOrgNameBackAriaLabel = "UpdateOrgNameBackAriaLabel";
        public const string UpdateOrgAddressBackAriaLabel = "UpdateOrgAddressBackAriaLabel";
