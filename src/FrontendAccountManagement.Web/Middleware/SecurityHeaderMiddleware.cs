...
public class SecurityHeaderMiddleware
{
    ...
    public async Task Invoke(HttpContext httpContext, IConfiguration configuration)
    {
        ...
        httpContext.Response.Headers["Content-Security-Policy"] = GetContentSecurityPolicyHeader(scriptNonce, whitelistedFormActionAddresses);
        ...
        httpContext.Response.Headers["Permissions-Policy"] = permissionsPolicy;
